...
import ReaderSection from "./beyondCode/ReaderSection";
import CreativeSection from "./beyondCode/CreativeSection";
import ObsessionSection from "./beyondCode/ObsessionSection";
import MusicSection from "./beyondCode/MusicSection";
import ComfortZoneSection from "./beyondCode/ComfortSection";
import FunFactsSection from "./beyondCode/FunFactsSection";
import MoodboardSection from "./beyondCode/MoodBoardSection";
...
export default function Portfolio() {
  ...
  return (
    <Routes>
        ...
        element={
          <div className="min-h-screen bg-gradient-to-br from-[#210635] via-[#420D4B] to-[#7B337E] text-[#F5D5E0] px-6 py-10 font-sans">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <section className="grid md:grid-cols-2 gap-10 items-center py-10">
                ...
                <div>
                  ...
                  <p className="text-[#d8bfd2] text-lg leading-8 max-w-xl">
                    ...
                    about full stack development, UI/UX design, and building
              ...
              {/* Beyond The Code */}
              <section className="py-24 flex flex-col items-center justify-center text-center border-t border-[#ffffff15]">

                <p className="uppercase tracking-[5px] text-sm text-[#d8bfd2] mb-4">
                ...
                <p className="text-[#d8bfd2] max-w-2xl leading-8 text-lg mb-10">
                  A small glimpse into the things I love outside of tech —
                  books, music, creativity, aesthetics, and the little things
                  that inspire me every day.
                </p>

                <Link
                  to="/beyond-code"
                  className="group relative overflow-hidden px-8 py-4 rounded-full border border-[#ffffff20] bg-[#ffffff10] backdrop-blur-lg hover:bg-[#F5D5E0] hover:text-[#420D4B] transition-all duration-500 shadow-2xl"
                >
      ...
      <Route
        path="/reader"
        element={<ReaderSection />}
      />

      <Route
        path="/creative"
        element={<CreativeSection />}
      />

      <Route
        path="/obsessions"
        element={<ObsessionSection />}
      />
      ...
      <Route
        path="/comfort-zone"
        element={<ComfortZoneSection />}
      />

      <Route
        path="/fun-facts"
        element={<FunFactsSection />}
      />

      <Route
        path="/moodboard"
        element={<MoodboardSection />}
      />
